	...
	<section class="middlepart">
		...
		<div class="right-panel">
			<aside class="rightsection iframe dboard">
				<h2><?php if($companyid=="") { echo "Add"; } else { echo "Edit"; } ?> About E-commerce Hub <?php if($messageText!="") { ?>
				...
				<input type="hidden" name="pageid" value="<?php echo $pageid; ?>" />
					<ul>
						   ...
						   <li>
                          <label> About E-commerce hub:</label>
						  <br>
						  <br>
						  <textarea type="text" name="ecommhub" id="ecommhub" rows="3" cols="50" ><?php echo $rowDisp->fld_ecommhub;?></textarea>

  						
						<script>
							CKEDITOR.replace( 'ecommhub', {
								width: '700px',
					height: '400px',
