	...
	<section class="middlepart">
		...
		<div class="right-panel">
			<aside class="rightsection iframe dboard">
				<h2><?php if($companyid=="") { echo "Add"; } else { echo "Edit"; } ?> Attracting investment:<?php if($messageText!="") { ?>
				...
				<input type="hidden" name="pageid" value="<?php echo $pageid; ?>" />
					...
					<li>
                          <label>Attracting investment:</label>
						  <br>
						  <br>
						  <textarea type="investment" name="investment" id="desc" rows="3" cols="50" ><?php echo $rowDisp->fld_investment;?></textarea>

  						
						<script>
							CKEDITOR.replace( 'investment', {
								width: '700px',
					height: '400px',
