		...
		<div class="right-panel">
			...
			<?php if($successmsg!="") { ?><div id="categoryDeleted" class="alert alert-success" style="text-align:center;"><div <?php echo $headingcls; ?>><?php echo $successmsg; ?></div></div><?php } ?>
				...
				<li><input type="text" name="keywordsearch" class="search" value="<?php echo $keywordsearch; ?>" autofocus /></li>
					...
					<div class="addfiles"><a href="subcategory.php?pageid=<?php echo $pageid; ?>&parentid=<?php echo $_REQUEST['parentid'];?>"><i class="fa fa-plus-circle white"></i>Create Sub category</a></div>
					<div class="clr"></div>
						...
						<table class="table table-bordered table-hover">
							...
							if($numMgmt > 0)
							{
								while($rowMgmt = $rsMgmt->fetch_object())
								{
									...
									{
										$sts='Inactive';
										$showsts = '<a href="subcategory-del.php?catid='.$catid.'&parentid='.$parentid.'&pageid='.$pageid.'&status='.$sts.'&task=chk" title="active" class="activeicon"><i class="fa fa-check-circle green"></i></a>';
										
									}
									else
									{
										$sts='Active';
										$showsts = '<a href="subcategory-del.php?catid='.$catid.'&parentid='.$parentid.'&pageid='.$pageid.'&status='.$sts.'&task=chk" title="inactive" class="inactive"><i class="fa fa-times-circle red"></i></a>';
									}
									...
									{
										$featuredsts='0';
										$showfeatured = '<a href="subcategory-del.php?catid='.$catid.'&parentid='.$parentid.'&pageid='.$pageid.'&featured='.$featuredsts.'&task=set" title="active" class="activeicon"><i class="fa fa-check-circle green"></i></a>';
										
									}
									else
									{
										$featuredsts='1';
										$showfeatured = '<a href="subcategory-del.php?catid='.$catid.'&parentid='.$parentid.'&pageid='.$pageid.'&featured='.$featuredsts.'&task=set" title="inactive" class="inactive"><i class="fa fa-times-circle red"></i></a>';
									}
 								...
 								<tr>
									...
									<td><a href="category-mgmt.php"><?php echo $mainCategory; ?></a></td>
...
-->							  <a class="edit-table" data-toggle="tooltip" data-original-title="Sub Category" title="Subsub Category" href="subsubcategory-mgmt.php?parentid=<?php echo $catid; ?>&pageid=<?php echo $pageid; ?>"><i class="fa fa-list"></i></a>				
                             <a class="edit-table" data-toggle="tooltip" data-original-title="Edit" title="edit" href="subcategory.php?catid=<?php echo $catid; ?>&parentid=<?php echo $parentid; ?>&pageid=<?php echo $pageid; ?>"><i class="fa fa-pencil"></i></a>	
										<a href="subcategory-del.php?catid=<?php echo $catid; ?>&parentid=<?php echo $parentid; ?>&pageid=<?php echo $pageid; ?>&task=del" onclick="return confirmDelete();" class="edit-table" title="delete"> <span id="<?=$sr?>"  data-toggle="tooltip" data-placement="left" title="Delete"><i class="fa fa-trash"></i></span></a>
									</td>
								</tr>
								<?php
								$sr++;
