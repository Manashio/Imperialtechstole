...
$Pagename = "University Management";
...
if($msgupd==1) { $successmsg = "University successfully Added!"; }
elseif($msgupd==2) { $successmsg = "University successfully edited!"; }
elseif($msgupd==3) { $successmsg = "University status successfully changed!"; }
elseif($msgupd==4) { $successmsg = "University deleted Successfully!"; }
...
$sqlPgn = "SELECT count(*) as cnt FROM tbl_university $keysearch";
...
$sqlMgmt = "SELECT * FROM tbl_university $keysearch ORDER BY fld_id DESC,fld_name ASC LIMIT $startPage, $RecsToShow";
		...
		<div class="right-panel">
			...
			<?php if($successmsg!="") { ?><div id="categoryDeleted" class="alert alert-success" style="text-align:center;"><div <?php echo $headingcls; ?>><?php echo $successmsg; ?></div></div><?php } ?>
				...
				<li><input type="text" name="keywordsearch" class="search" value="<?php echo $keywordsearch; ?>" autofocus /></li>
					...
					<div class="addfiles"><a href="university.php?pageid=<?php echo $pageid; ?>"><i class="fa fa-plus-circle white"></i>Create University</a></div>
					<div class="clr"></div>
