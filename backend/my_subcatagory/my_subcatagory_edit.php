...
<div class="content">
     <div class="container">
          ...
          <?php include_once('../subview/bc.php');?>
                ...
                <form action="my_subcatagory_update.php" method="post">
                    <input type="hidden" name="id" id="" class="form-control input_bar" value="<?php echo $getRow['my_id']; ?>" required>                  
                    <input type="text" name="new_name" id="" class="form-control input_bar" value="<?php echo $getRow['my_subcatagory_name']; ?>" required>
                    <input type="text" name="new_seo" id="" class="form-control input_bar" value="<?php echo $getRow['my_subcatagory_seo']; ?>" required>
                    <input type="text" name="new_pagename" class="form-control input_bar" id="" value="<?php echo $getRow['my_pagename']; ?>" required>
                    <input type="text" name="new_status" class="form-control input_bar" id="" value="<?php echo $getRow['my_subcatagory_status']; ?>" required>
