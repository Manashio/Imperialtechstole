...
class myclass
{
	...
	function notifecation()
	{
		  $sql="SELECT * FROM tbl_notice_board WHERE status='1' order by id desc";
...
function scrolling()
	{
		 $sql="SELECT * FROM scroltxt WHERE status='1' order by id desc";
...
function content()
	{
	$P_ID=$_GET['P_ID'];
		 $sql="SELECT * FROM pcf_pge_cntnt WHERE  page_id='$P_ID'  && page_status='1'";
...
function contenthome()
	{
	//$P_ID=$_GET['P_ID'];
		 $sql="SELECT * FROM pcf_pge_cntnt WHERE  page_id='19'  && page_status='1'";
