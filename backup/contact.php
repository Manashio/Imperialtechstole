<?php include_once("plugins/mainCls.php"); $notifecation = $s->notifecation(); $scrol = $s->scrolling(); $cnt = $s->content(); $homec=$s->contenthome();?>
  ...
  <div class="container">
    <div class="col-md-12">
      ...
      <div class="col-md-4">
      	<h3>ADDRESS</h3>
       <?php 
			$sql="SELECT * FROM pcf_pge_cntnt WHERE  page_id='45'  && page_status='1'";
		...
		$result=mysql_query($sql);
			...
			;?>
			<?php 
											 echo $RS['page_content'];?> 
      </div>
      
      <div class="col-md-5">
       <div class="form-area">  
        <form role="form" method="post" action="thanks1.php">        
                    ...
                    <div class="form-group">
                    <textarea class="form-control" type="textarea" id="query" placeholder="Message" maxlength="140" rows="7"></textarea>
                    </div>
...
<div>
	<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7010.4484014192485!2d77.21313002264068!3d28.53298007982862!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce21fee634397%3A0xd876ac78ca4d8aa8!2sKhirki+Extension%2C+Block+J%2C+Khirki+Extension%2C+Malviya+Nagar%2C+New+Delhi%2C+Delhi+110017!5e0!3m2!1sen!2sin!4v1483438356851" width="100%" height="350" frameborder="0" style="border:0" allowfullscreen></iframe>
</div>
