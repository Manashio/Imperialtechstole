...
function delSeller()
{
	var x = confirm("Deleting the sales rep will delete all its related records like coupon. Are you sure?");
	if(x)
	{
		return true;
	}
...
{
	var x = confirm("Deleting the category will delete all its subcategories.");
	if(x)
	{
		return true;
	}
