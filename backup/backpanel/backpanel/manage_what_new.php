...
include("include/paging.php");
	...
	{
		 $file_array["status"] 	= "0";
		$result=$s->editRecord('tbl_notice_board',$file_array,'id',$pcode);
	}
	...
	if($data_action == 'delete')
	{
			...
			$result=$s->deletPerma_table_withCondition('tbl_notice_board','id',$pcode);
		
	}
	$itemPerPage=30;

 		$records = "SELECT * FROM tbl_notice_board order by id asc";
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="24%" class="pageheadTop">Manage Blog</td>
            <td width="76%" class="headLink" align="right">		
				<ul>
                <li><a href="index.php?pgnm=add_whats_new">Add Blogs</a></li>
              </ul>
...
<?php
  ...
  <tr class="text" onmouseover="bgr_color(this, '#FFFF99')" onMouseOut="bgr_color(this, '')" >
    <td align="center"><?php echo $i; ?></td>
     <td style="text-align:center;"><?php if($row->title!=''){ echo $row->title; } else { echo "N/A"; } ?></td>
    <td style="text-align:left;"><?php  echo $row->description; ?></td>


	 
    <td align="center" width="81">
	<?php  if($row->status =="1"){?><img src="images/green.gif" title="Inactive" border="0"  />&nbsp;&nbsp;&nbsp;&nbsp;<a href="index.php?pgnm=manage_what_new&action=deactivate&pcode=<?php echo $row->id;?>"><img src="images/red_light.gif" title="Inactive" border="0"  /></a>
<?php
	}
	else if($row->status =="0")
	{
 ?>
<a href="index.php?pgnm=manage_what_new&action=activate&pcode=<?php echo $row->id;?>"><img src="images/green_light.gif" title="Active" border="0"  /></a> &nbsp;&nbsp;&nbsp;<img src="images/red.gif" title="Inactive" border="0"  />
<?php		
	} 
?>
	</td>
     
    <td align="center"><a href="index.php?pgnm=update_whats_new&action=edit&pcode=<?php echo $row->id;?>"><img src="images/e.gif" title="Edit" border="0"  /></a> </td>

 <?php if($_SESSION["Super_ADMIN"]=='1'){?>   
    <td align="center"><a href="index.php?pgnm=manage_what_new&action=delete&pcode=<?php echo $row->id;?>" onclick='return del();'><img src="images/x.gif" title="Delete" border="0"  /></a> </td><?php } ?>
  </tr>
  <?php  $i++; } ?>
