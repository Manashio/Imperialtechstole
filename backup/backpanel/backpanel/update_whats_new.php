...
$id=$_REQUEST['pcode'];
$query=mysql_query("select * from tbl_notice_board where id='$id'");
$row=mysql_fetch_object($query);
	...
	$sql = mysql_query("update tbl_notice_board set title='$title',description='$description',status='$status' where id=$id ");
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <td>
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        ...
        <tr>
          ...
          <tr>
            <td width="24%" class="pageheadTop">Update Blogs</td>
 ...
 <tr>
    <td><p><strong>Title</strong><strong>:</strong></p></td>
    <td align="center"></td>
    <td><input type="text" size="49" name="title" value="<?php echo $row->title; ?>" ></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td align="center">&nbsp;</td>
    ...
    <td align="center"></td>
    <td>  <textarea  name="description" id="description" ><?php echo $row->description; ?></textarea>
