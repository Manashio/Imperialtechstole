...
$sqlProd = "SELECT * FROM tbl_service WHERE fld_id='21' ";
...
<link rel="canonical" href="http://www.imperialtechsol.com/board-room-conference.php" />
<!-- Stylesheets -->
...
<section class="left-nav">
  <div class="container">
	...
	<tbody>
		<tr>
			<td width="88%">
				<img align="right" src="<?php echo $imagePath.$image;?>" width="405" height="209"  style="padding:10px;"/><?php echo $rowProd->fld_desc;?></td>
		</tr>
	</tbody>
</table>      </div>
    </div>
