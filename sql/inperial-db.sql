...
--
-- Host: localhost:3306
-- Generation Time: Mar 31, 2018 at 06:38 AM
...
CREATE TABLE IF NOT EXISTS `tbl_addonimages` (
...
CREATE TABLE IF NOT EXISTS `tbl_appliedfor` (
...
CREATE TABLE IF NOT EXISTS `tbl_buyoffer` (
  `fld_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `tbl_ecomm` (
  `fld_id` int(11) NOT NULL AUTO_INCREMENT,
  `fld_email` varchar(255) NOT NULL,
  `fld_password` varchar(255) NOT NULL,
  `fld_company_name` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tbl_exp_section` (
  `fld_id` int(11) NOT NULL AUTO_INCREMENT,
  `fld_email` varchar(255) NOT NULL,
  `fld_password` varchar(255) NOT NULL,
  `fld_company_name` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tbl_selloffer` (
  `fld_id` int(11) NOT NULL AUTO_INCREMENT,
  `fld_company_id` int(11) NOT NULL,
  `fld_catid` int(11) NOT NULL,
  `fld_subcatid` int(11) NOT NULL,
...
(35, 0, 0, 0, '1997447072', 'Auditorium Projector - HD Projector', '', '', '', 'auditorium-projector', 'AERO4201521101678.jpg', '', '', '', '', '', '', 'Auditorium Projector Supplier, HD Projector Dealer India', 'Auditorium Projector, hd projector, HD Projector Dealer India, Auditorium Projector supplier, Auditorium Projector supplier india', 'Auditorium Projector Supplier India- Imperial Techsol offers the Auditorium hd projector supplier across India at best prices.', '2018-03-15 01:45:25', 0, 'Active', 0),
