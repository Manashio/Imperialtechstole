...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 16, 2018 at 12:56 PM
...
CREATE TABLE `my_format_display` (
  ...
  `my-display_created_at` int(11) NOT NULL,
...
INSERT INTO `my_format_display` (`my_id`, `my_subcatagory_id`, `my_display_name`, `my_display_size`, `my_display_brand`, `my_display_specification`, `my_display_broucher`, `my_display_image`, `my_display_status`, `my-display_created_at`, `my_display_updated_at`) VALUES
...
INSERT INTO `my_videowall` (`my_id`, `my_catagory_id`, `my_video_name`, `my_video_description`, `my_video_image`, `my_video_seo`, `my_video_status`, `my_video_created_at`, `my_video_updated_at`) VALUES
(1, 1, 'LCD Video Wall\r\n', 'LCD description given here.\r\n', '', '', 'active', 0, 0),
(2, 1, 'LED Video Wall', 'LED description given here.', '', '', 'active', 0, 0);
